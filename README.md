...
![pic of the onboarding screen](screenshots/onboarding.png "onboarding")
...
![pic of the dashboard](screenshots/dashboard.png "dashboard")

2. trackers -> here u can log not only ur preventer & rescue inhaler, but also symptoms and symptom/attack triggers

![pic of the trackers screen](screenshots/trackers.png "trackers")
...
![pic of the attack mode screen](screenshots/attack.png "attack mode")

4. calendar overview -> here u can view when u logged what 

![pic of the calendar overview](screenshots/calendar.png "calendar")

5. settings -> here u can view ur profile data, export it or reset it to restart the onboarding process

![pic of the settings](screenshots/settings.png "settings")
...
https://github.com/user-attachments/assets/0550fa32-6563-482a-97e8-bac99ef9ad07
